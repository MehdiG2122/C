...
BlackScholesEulerSimulator::BlackScholesEulerSimulator(const BlackScholesModel& model_, long num_steps_, double T_): BlackScholesSimulator(model_, num_steps_,T_){}
